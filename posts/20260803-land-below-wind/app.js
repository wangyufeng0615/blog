...
const COPY = {
  zh: {
    ...
    homeQuoteSource: "2016 中译本 · 扫描 PDF p.191",
    ...
    coastQuoteSource: "2016 中译本 · 扫描 PDF p.198",
    ...
    kalabakanQuoteSource: "2016 中译本 · 扫描 PDF p.222",
    ...
    tiagauQuoteSource: "2016 中译本 · 扫描 PDF p.255",
    ...
    floodQuoteSource: "2016 中译本 · 扫描 PDF p.267",
    floodSource: "原书剧情线索",
    ...
    biyudunQuoteSource: "2016 中译本 · 扫描 PDF p.283",
    ...
    kuamutQuoteSource: "2016 中译本 · 扫描 PDF p.292",
    kuamutSource: "原书剧情线索",
    ...
    relatedQuoteSource: "2016 中译本 · 扫描 PDF p.220",
    ...
    illustrationRights: "本地研究预览｜下列插画裁自你提供的 2016 生活·读书·新知三联书店扫描本；版权页标明未经许可不得翻印。公开发布前须取得授权，或替换为已确认权利状态的图像。",
    ...
    illustration1Alt: "独木舟上的船夫", illustration1Caption: "独木舟上的船夫｜原书插画，随第十二章《一把蓝雨伞》｜扫描本 PDF p.221",
    illustration2Alt: "暴雨中的帐篷营地", illustration2Caption: "雨夜营地｜原书插画｜扫描本 PDF p.244",
    illustration3Alt: "队伍穿过茂密的热带雨林", illustration3Caption: "雨林中的队伍｜原书插画，随第十三章《丛林中的泥泞》｜扫描本 PDF p.252",
    illustration4Alt: "船夫在急流中拖起独木舟", illustration4Caption: "船夫从急流中拖起 perahu｜原书插画｜扫描本 PDF p.271",
    illustration5Alt: "小船载着探险者沿河归来", illustration5Caption: "探险者归来｜原书插画，随第十四章｜扫描本 PDF p.286",
    methodLead: "这是一条证据链，也是一张仍可修订的地图。", methodTitle: "路线如何被重建",
    method1Title: "原书与版本", method1Body: "1939 年初版书目明确记载环衬上附有地图；可检索正文用于核对行程场景与旧地名。页面保留两处极短英文原句，并从用户提供的 2016 中文扫描本选取八则短引；其余剧情均用自己的话转述。五幅插画同样来自该扫描本，仅用于本地研究预览。",
  ...
  en: {
    ...
    homeQuoteSource: "Rendered from the supplied 2016 Chinese edition · scan PDF p. 191",
    ...
    coastQuoteSource: "Rendered from the supplied 2016 Chinese edition · scan PDF p. 198",
    ...
    kalabakanQuoteSource: "Rendered from the supplied 2016 Chinese edition · scan PDF p. 222",
    ...
    tiagauQuoteSource: "Rendered from the supplied 2016 Chinese edition · scan PDF p. 255",
    ...
    floodQuoteSource: "Rendered from the supplied 2016 Chinese edition · scan PDF p. 267",
    ...
    biyudunQuoteSource: "Rendered from the supplied 2016 Chinese edition · scan PDF p. 283",
    ...
    kuamutQuoteSource: "Rendered from the supplied 2016 Chinese edition · scan PDF p. 292",
    ...
    relatedQuoteSource: "Rendered from the supplied 2016 Chinese edition · scan PDF p. 220",
    ...
    notesRightsBody: "Eight brief translated excerpts and five author-drawn illustrations come from the supplied 2016 SDX Joint Publishing Chinese edition. The English excerpt text on this page is a fresh rendering from that Chinese edition, not a claim to reproduce the unverified 1939 wording. Review quotation scope and obtain illustration permission before public release.",
    ...
    illustrationRights: "Local research preview | These illustrations were cropped from the user-supplied 2016 SDX Joint Publishing Chinese edition. Its copyright page reserves all rights. Obtain permission or replace them with cleared images before publication.",
    ...
    illustration1Alt: "A boatman standing in a perahu", illustration1Caption: "Boatman in a perahu | Illustration from the book, opening Chapter 12, ‘A Blue Umbrella’ | supplied scan, PDF p. 221",
    illustration2Alt: "A tent camp under driving rain", illustration2Caption: "Camp in the rain | Illustration from the book | supplied scan, PDF p. 244",
    illustration3Alt: "A party crossing dense tropical rainforest", illustration3Caption: "The party in the rainforest | Illustration from the book, opening Chapter 13 | supplied scan, PDF p. 252",
    illustration4Alt: "Boatmen hauling a perahu through rapids", illustration4Caption: "Boatmen hauling a perahu through rapids | Illustration from the book | supplied scan, PDF p. 271",
    illustration5Alt: "Travellers returning by river boat", illustration5Caption: "The explorers return | Illustration from the book, opening Chapter 14 | supplied scan, PDF p. 286",
    methodLead: "This is an evidence chain—and a map that can still be revised.", methodTitle: "How the route was reconstructed",
    method1Title: "The book and its editions", method1Body: "The catalogue record for the 1939 first edition explicitly notes a map on the lining papers. Searchable text was used to verify scenes and historical spellings. The page retains two very short verified English quotations and adds eight brief excerpts from the supplied 2016 Chinese scan; their English text here is newly rendered from that edition. All other plot material is paraphrased. Five illustrations from the same scan remain limited to this local research preview.",
    ...
    publicationNote: "Before publication | Confirm permission to reproduce the five scanned illustrations. If permission is unavailable, replace them with images whose rights status has been cleared."
  }
};
